                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Text("Password Has Been Created", style: AppTextStyles.boldTextStyle.copyWith(
                          color: AppColors.black,
                        )),
                        verticalSpace(0.4.h),
                        Text("To log in to your account, click the Sign in button\n and enter your email along with your new\n password.", style: AppTextStyles.smallTextStyle,
                          textAlign: TextAlign.center,),
                        verticalSpace(4.h),
                        CustomButton(height: 5.5.h, title: "Sign In", onTap: () {
                          Get.close(4);
                        }),
                        verticalSpace(2.h),
